...
void initializeGrandPotential(latticeArr myLattice, latticeD1Q3 myD1Q3,  nonIdealParam myVDW, int nX, double vel, double rhoMean, double ampDisturb, double periodDisturb)
{
    ...
    for(iX =3; iX<=nX+2;iX++)
    {
        ...
        myLattice[iX].chi = rho*rho*myVDW.b*myD1Q3.T0/(1.0-myLattice[iX].rho*myVDW.b) ;
    }
...
//     dt *= 0.1;
    ...
    {
       double chieqnid = myLattice[iX].rho*myLattice[iX].rho*myVDW.b*myD1Q3.T0/(1-myLattice[iX].rho*myVDW.b) ;
...
//     dt *= 0.1;
    ...
    // // // Predictor // // //
    for( int iX = nX+2  ; iX >=3 ; iX--)
       myLattice[iX].chiPredictor = myLattice[iX].chi - dt/dx*( myLattice[iX+1].chi*myLattice[iX+1].vel - myLattice[iX].chi*myLattice[iX].vel ) ;
    ...
    // // // Corrector // // //
    for( int iX = nX+2  ; iX >=3 ; iX--)
       myLattice[iX].chiCorrector = 0.5*( myLattice[iX].chiPredictor + myLattice[iX].chi ) - dt/dx*( myLattice[iX].chiPredictor*myLattice[iX].vel - myLattice[iX-1].chiPredictor*myLattice[iX-1].vel ) ;
...
//         myLattice[iX].Force = ;
          double Force_i    = -(myLattice[iX+1].pNid - myLattice[iX-1].pNid)/(dX*2.0) - myLattice[iX].rho*(myLattice[iX+1].ForceAtt -myLattice[iX-1].ForceAtt)/(dX*2.0);
...
//         myLattice[iX].pNid = myVDW.b*myLattice[iX].rho*myLattice[iX].rho*myD1Q3.T0/(1-myVDW.b*myLattice[iX].rho) ;//- myLattice[iX].rho*myLattice[iX].rho*myVDW.a ;
       myLattice[iX].pNid = myLattice[iX].chi ;
        //surface energy
    } 
   	...
   	for( iX = nX+2; iX >=3; iX--)
    {
        ...
        myLattice[iX].ForceAtt = -2.0*myLattice[iX].rho*myVDW.a ;
    }
    ...
    myLattice[0     ].ForceAtt = myLattice[nX     ].ForceAtt ;
    myLattice[1     ].ForceAtt = myLattice[nX + 1 ].ForceAtt ;
    myLattice[2     ].ForceAtt = myLattice[nX + 2 ].ForceAtt ;
    myLattice[nX + 3].ForceAtt = myLattice[3      ].ForceAtt ;
    myLattice[nX + 4].ForceAtt = myLattice[4      ].ForceAtt ;
    myLattice[nX + 5].ForceAtt = myLattice[5      ].ForceAtt ;
...
//     myLattice[nX + 5].surface = myLattice[5].surface ;
    ...
    for( iX = nX+2; iX >=3 ; iX--)
    {
        ...
        myLattice[iX].Force = myLattice[iX].rho*(myLattice[iX+1].ForceAtt -myLattice[iX-1].ForceAtt)/(dx*2.0);
