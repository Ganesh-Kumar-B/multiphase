...
//     } 
    ...
    //$pressure from Pnid vander waals EOS
        for( iX = nX+2 ; iX >=3 ; iX--)
    {
       myLattice[iX].pNid = (myLattice[iX].rho*myLattice[iX].rho* myVDW.b *myD1Q3.T0  )/(1.0 - myLattice[iX].rho*myVDW.b)  - myVDW.a * myLattice[iX].rho*myLattice[iX].rho ;
