...
void Diffuse_41(Grid_N_C_3D<T> &grid,  lbmD3Q41<T1> &lb, real utop, real ubottom){
...
template<typename T, typename T1>
void BB_wall_bottom(Grid_N_C_3D<T> &grid,  lbmD3Q41<T1> &lb, real utop, real ubottom){
...
template<typename T, typename T1>
void BB_wall_left(Grid_N_C_3D<T> &grid,  lbmD3Q41<T1> &lb, real utop, real ubottom){
    ...
    int leftC_last[]       =   { 
                                ...
                                dV_M1_P1_P1     ,dV_M1_P1_M1    ,dV_M1_M1_P1    ,dV_M1_M1_M1    ,
                                };
...
template<typename T, typename T1>
void BB_wall_top(Grid_N_C_3D<T> &grid,  lbmD3Q41<T1> &lb, real utop, real ubottom){
...
template<typename T, typename T1>
void BB_wall_right(Grid_N_C_3D<T> &grid,  lbmD3Q41<T1> &lb, real utop, real ubottom){
    ...
    //#--rightwall
     ...
     int rightC_last[]       =   {  dV_P2_ZERO_ZERO ,
                                    ...
                                    dV_P1_P1_P1     ,dV_P1_P1_M1    ,dV_P1_M1_P1    ,dV_P1_M1_M1    ,
