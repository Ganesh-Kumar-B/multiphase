...
template<typename T>
void Diffuse_B1(Grid_N_C_2D<T> &grid,lbmD2Q9<T> &lbd2q9,real u0){   //looping over the outgoing populations
...
//1st order
template<typename T>
void Diff_non_align_general(Grid_N_C_2D<T> &grid,lbmD2Q9<T> &lbd2q9,real u0,real del){ //1st order
...
//note //////===============================================2ND ORDER================================///////////////////
template<typename T>
void Diff_2nd_order_non_align(Grid_N_C_2D<T> &grid,lbmD2Q9<T> &lbd2q9,real u0,real del){ 

    real nx,y1,w1,w2; 
    real ny,ux ,uy = 0,rho = 1.0,G = 0; //top
    int j,ic= 0 ,jc = 0;u0= u0;
    real feq[9] = {0};
...
void G_calc(Grid_N_C_2D<T> &grid,lbmD2Q9<T> &lbd2q9){ //indirectly contain the local normal of aerofoil
    ...
    real feq[9] = {0};
    real ux = 0; real uy = 0; real rho = 1.0;
    get_equi(feq,lbd2q9, ux, uy, rho);
...
template<typename T>
void Diffuse_B_Solid(Grid_N_C_2D<T> &grid,lbmD2Q9<T> &lbd2q9,real u0){ 
...
template<typename T, typename T1>
void slip_wall(Grid_N_C_2D<T> &lbgrid,lbmD2Q9<T1> &lbD3Q9, real ux, real uy,real rho){
...
template<typename T, typename T1>
void inlet(Grid_N_C_2D<T> &lbgrid,lbmD2Q9<T1> &lbD3Q9, real ux, real uy,real rho){
...
template<typename T, typename T1>
void outlet(Grid_N_C_2D<T> &lbgrid,lbmD2Q9<T1> &lbD3Q9, real ux, real uy,real rho){
...
// template<typename T, typename T1>
// void inlet(Grid_N_C_2D<T> &lbgrid,lbmD2Q13<T1> &lbD3Q13, real ux, real uy,real rho){


// real feq_Node[13] = {0},feq_Cell[13] = {0};
...
// template<typename T, typename T1>
// void outlet(Grid_N_C_2D<T> &lbgrid,lbmD2Q13<T1> &lbD3Q13, real ux, real uy,real rho){
